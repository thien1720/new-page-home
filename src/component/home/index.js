    ...
    return <>
        ...
        <section className={cx("content")}>
            <div className={cx("content-feature")}>
                <p className={cx("feature-intro")}>"Nếu bạn đồng hành cùng Cơm Có Thịt, thì đó chỉ là do mệnh lệnh từ trái tim của bạn" - Trần Đăng Tuấn</p>
            </div>

            {/* transfer info */}
            <div className={cx("transparency-info", "container")}>
                ...
                <div className={cx("row")}>
                    <div className={cx("total-bank col-xs-12 col-md-6")}>
            ...
            <div className={cx("support-list", "container-xl")}>
